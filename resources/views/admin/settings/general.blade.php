        ...
        <form method="POST" action="{{ route('admin.settings.general.update') }}" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                    ...
                    <input type="text" name="whatsapp_number" value="{{ old('whatsapp_number', $settings['whatsapp_number'] ?? '') }}" placeholder="WhatsApp" class="mt-1 w-full rounded-xl border border-wood-400/20 bg-white/70 px-4 py-2.5 text-sm">
                </div>
                <div>
